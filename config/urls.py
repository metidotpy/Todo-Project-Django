...
urlpatterns = [
    ...
    path("password/reset/", PasswordResetView.as_view(template_name='accounts/password_reset.html/', success_url=reverse_lazy('password_reset_done')), name='password_reset_view'),
